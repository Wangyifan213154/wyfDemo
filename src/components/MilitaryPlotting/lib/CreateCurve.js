 ...
 * @Last Modified time: 2022-04-21 08:57:55
 */
  ...
  handler.setInputAction(function (movement) {
    ...
    if (anchorpoints.length > 0) {
      if (!window.XEarth.defined(polyline)) {
        ...
        linePoints = window.XEarth.Cartesian3.fromDegreesArray(geoPoints)
        ...
        linePoints = window.XEarth.Cartesian3.fromDegreesArray(GeoPoints1)
      }
    }
