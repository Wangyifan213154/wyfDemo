...
const vec3 skycolour3 = vec3(0.4, 0.8, 1.0);
...
czm_material czm_getMaterial(czm_materialInput materialInput)
  {
      ...
      float iTime = czm_frameNumber/240.0;
      vec2 iResolution = normalize(czm_viewport.zw);
      
      vec2 uv = st*2.0-vec2(1.0);  //fragCoord / iResolution.y;
    ...
    //   vec2 uv = p*vec2(iResolution.x/iResolution.y,1.0);    
      ...
      vec3 skycolour = skycolour3;//mix(skycolour2, skycolour1, p.y);
      ...
      float a = smoothstep(0.0, 1.0, pow(fragColor.r,2.0));
      material.alpha = a;
      return material;
  }
	`
