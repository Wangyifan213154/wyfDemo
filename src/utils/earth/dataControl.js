...
class DataControl {
  ...
  addGeojsonData(options) {
    ...
    var promise = window.XEarth.GeoJsonDataSource.load(options.url)
      ...
      for (let i = 0; i < entities.length; i++) {
        ...
        switch (geoType) {
          ...
          case 'polygon':
            ...
            //   entity.polygon.material = window.XEarth.Color.CYAN.withAlpha(0.2)
            //   entity.polygon.outlineColor = window.XEarth.Color.CYAN.withAlpha(0.7)
            // } else if (entity._name.indexOf('海') > -1) {
            //   entity.polygon.material = window.XEarth.Color.CRIMSON.withAlpha(0.2)
            //   entity.polygon.outlineColor = window.XEarth.Color.CRIMSON.withAlpha(0.7)
            // } else {
            //   entity.polygon.material = options.color
            // }
            entity.polygon.material = window.XEarth.Color.CYAN.withAlpha(0.2)
            entity.polygon.outlineColor =
              window.XEarth.Color.CYAN.withAlpha(0.6)
            entity.polyline = {
              positions: entity.polygon.hierarchy._value.positions,
              width: 10,
              material: new window.XEarth.AreaLineBMaterialProperty({
                color: window.XEarth.Color.CYAN,
                duration: 400
              })
            }
            break
        ...
        if (options.addLabel) {
          ...
          if (entity.properties) {
            ...
            let color = window.XEarth.Color.WHITE
            if (textVal == '中华人民共和国') {
            ...
            entity.label = {
              ...
              horizontalOrigin: window.XEarth.HorizontalOrigin.LEFT, //水平位置
              verticalOrigin: window.XEarth.VerticalOrigin.BOTTOM,
              pixelOffset: new window.XEarth.Cartesian2(-33, -11),
              eyeOffset: new window.XEarth.ConstantProperty(
                new window.XEarth.Cartesian3(0, 0, -11)
              ),
              distanceDisplayCondition:
                new window.XEarth.DistanceDisplayCondition(nearDis, farDis)
            }
          }
        }
      }
  ...
  _addDHFKSBQ() {
    const options = {
      ...
      color: window.XEarth.Color.RED, //152, 56, 93
      addLabel: false,
      dataType: 'vector',
      geoType: 'point',
      id: '防空1'
    ...
    // 东海防空识别区的标识
    let center = new window.XEarth.Cartesian3.fromDegrees(
      124.56142578414978,
      29.088438770842423
    )
    let centerTW = new window.XEarth.Cartesian3.fromDegrees(
      120.83108755879553,
      23.589335002507163
    )
    var heading = -window.XEarth.Math.PI_OVER_TWO
    var pitch = window.XEarth.Math.PI_OVER_FOUR
    var roll = 0.0
    var hpr = new window.XEarth.HeadingPitchRoll(heading, pitch, roll)
    var quaternion = window.XEarth.Transforms.headingPitchRollQuaternion(
      centerTW,
      hpr
    )
    window.EarthViewer.entities.add({
      ...
      label: {
        // text: '财政局西门',
        text: '东海防空识别区',
        // backgroundColor: new window.XEarth.Color(1.0, 153 / 255, 18 / 255, 1.0),
        ...
        horizontalOrigin: window.XEarth.HorizontalOrigin.LEFT, //水平位置
        verticalOrigin: window.XEarth.VerticalOrigin.BOTTOM,
        pixelOffset: new window.XEarth.Cartesian2(-63, 11),
        eyeOffset: new window.XEarth.ConstantProperty(
          new window.XEarth.Cartesian3(0, 0, -11)
        ),
  ...
  addTWFKSBQ() {
    window.EarthViewer.entities.add({
      ...
      polyline: {
        positions: window.XEarth.Cartesian3.fromDegreesArray([
          117.5, 29.0, 123.0, 29.0, 123, 22.5, 121.5, 21, 117.5, 21, 117.5, 29
        ]),
        width: 2,
        material: window.XEarth.Color.BLUE.withAlpha(1),
        clampToGround: true,
        distanceDisplayCondition: new window.XEarth.DistanceDisplayCondition(
          20e5,
          100e5
    ...
    window.EarthViewer.entities.add({
      ...
      label: {
        ...
        font: 'normal 46px MicroSoft YaHei',
        scale: 0.5,
        fillColor: window.XEarth.Color.BLUE,
        style: window.XEarth.LabelStyle.FILL_AND_OUTLINE,
        // outlineWidth: 2,
        horizontalOrigin: window.XEarth.HorizontalOrigin.LEFT, //水平位置
        verticalOrigin: window.XEarth.VerticalOrigin.BOTTOM,
        pixelOffset: new window.XEarth.Cartesian2(-73, 11),
        eyeOffset: new window.XEarth.ConstantProperty(
          new window.XEarth.Cartesian3(0, 0, -11)
        ),
        distanceDisplayCondition: new window.XEarth.DistanceDisplayCondition(
      ...
      for (let i = 0; i < entities.length; i++) {
        ...
        switch (geoType) {
          case 'point':
            ...
            if (options.id == '防空1') {
              ...
              self.createBillboardLabel_DC({
                ...
                offset: new window.XEarth.Cartesian2(0, -40),
              ...
              let imageUrl = ''
              let color = window.XEarth.Color.RED
              switch (options.id) {
                case 'debris':
                ...
                case 'landslide':
                  ...
                  color = window.XEarth.Color.BLUEVIOLET
                  break
                case 'earthquake':
              ...
              entity.billboard = {
                ...
                rotation: 0.0,
                eyeOffset: new window.XEarth.ConstantProperty(
                  new window.XEarth.Cartesian3(0, 0, -1)
                ),
                pixelOffset: new window.XEarth.Cartesian2(0.0, -25),
                ...
                distanceDisplayCondition:
                  new window.XEarth.DistanceDisplayCondition(0, 100e5),
                disableDepthTestDistance: Number.POSITIVE_INFINITY
              }
              ...
              entity.ellipse = {
                ...
                material: new window.XEarth.PulseMaterialProperty({
                  color: color,
              ...
              //   pixelOffset: new window.XEarth.Cartesian2(20, -60),
              //   // showBackground: true,
              //   backgroundColor: new window.XEarth.Color.fromBytes(235, 155, 33),
              //   distanceDisplayCondition: new window.XEarth.DistanceDisplayCondition(
              //     0,
              //     100e5
              //   )
              ...
              entity.label = {
                ...
                horizontalOrigin: window.XEarth.HorizontalOrigin.LEFT,
                verticalOrigin: window.XEarth.VerticalOrigin.CENTER,
                pixelOffset: new window.XEarth.Cartesian2(0, -40),
                outlineColor: window.XEarth.Color.BLACK,
                outlineWidth: 2,
                // showBackground: true,
                backgroundColor: new window.XEarth.Color.fromBytes(
                  235,
                  155,
                  33
                ),
              ...
              if (typeof entity.properties.position != 'undefined') {
                ...
                self.createBillboardLabel_DC({
                  ...
                  color: window.XEarth.Color.GREENYELLOW,
                  labelScale: 0.6,
                  offset: new window.XEarth.Cartesian2(0, -40),
          ...
          case 'polyline':
            ...
            entity.polyline.clampToGround = true,
              ...
              new window.XEarth.DistanceDisplayCondition(20e5, 100e5)
            entity.billboard = undefined
            if (options.id == 'guojiexian') {
              entity.polyline.width = options.width
              entity.polyline.material = new window.XEarth.Color(
                186 / 255,
                105 / 255,
                102 / 255,
                0.7
              ...
              entity.polyline.distanceDisplayCondition =
                new window.XEarth.DistanceDisplayCondition(20e5, 350e5)
            } else if (options.id === 'zyRiver_link') {
              entity.polyline.width = options.width
              entity.polyline.material =
                window.XEarth.Color.DODGERBLUE.withAlpha(0.5)
              entity.polyline.distanceDisplayCondition =
                new window.XEarth.DistanceDisplayCondition(0, 100e5)
              entity.polyline.width = options.width
              ...
              entity.polyline.distanceDisplayCondition =
                new window.XEarth.DistanceDisplayCondition(20e5, 70e5)
            } else if (
              options.id == 'daolian1' ||
              options.id == 'daolian2' ||
              options.id == 'daolian3'
              ...
              // entity.polyline.distanceDisplayCondition =
              // new window.XEarth.DistanceDisplayCondition(20, 100e20)
              ...
              // entity.polyline.material = options.color
              //   ? options.color
              //   : new window.XEarth.Color(1.0, 0.0, 0.0, 1.0)
              entity.polyline.distanceDisplayCondition =
                new window.XEarth.DistanceDisplayCondition(20e5, 100e5)
              ...
              entity.polyline.distanceDisplayCondition =
                new window.XEarth.DistanceDisplayCondition(0, 30e5)
          ...
          case 'polygon':
            if (options.id == '4H2B') {
              if (entity._name == undefined) {
                // 等高线
                entity.polygon.outlineColor =
                  window.XEarth.Color.YELLOW.withAlpha(0.2)
                entity.polygon.fill = false
                entity.polygon.distanceDisplayCondition =
                  new window.XEarth.DistanceDisplayCondition(20e5, 250e5)
              } else if (entity._name == '中印' || entity._name == '中朝') {
                entity.polygon.material =
                  window.XEarth.Color.CYAN.withAlpha(0.2)
                entity.polygon.outlineColor =
                  window.XEarth.Color.CYAN.withAlpha(0.7)
                entity.polygon.distanceDisplayCondition =
                  new window.XEarth.DistanceDisplayCondition(20e5, 250e5)
              } else if (entity._name.indexOf('海') > -1) {
                entity.polygon.material =
                  window.XEarth.Color.CRIMSON.withAlpha(0.2)
                entity.polygon.outlineColor =
                  window.XEarth.Color.CRIMSON.withAlpha(0.7)
                entity.polygon.distanceDisplayCondition =
                  new window.XEarth.DistanceDisplayCondition(20e5, 250e5)
              } else {
              ...
              entity.polygon.material = new window.XEarth.Color(
                1.0,
                0.0,
                0.0,
                0.0
              ...
              entity.polygon.outlineColor = window.XEarth.Color.YELLOW
              entity.polygon.distanceDisplayCondition =
                new window.XEarth.DistanceDisplayCondition(20e5, 250e5)
              ...
              entity.polygon.outline = true
              entity.polygon.outlineColor = window.XEarth.Color.RED
              entity.polygon.material = window.XEarth.Color.DIMGRAY
        ...
        if (options.addLabel) {
          ...
          entity.label = {
            ...
            horizontalOrigin: window.XEarth.HorizontalOrigin.LEFT, //水平位置
            verticalOrigin: window.XEarth.VerticalOrigin.BOTTOM,
            pixelOffset: new window.XEarth.Cartesian2(-63, -31),
            eyeOffset: new window.XEarth.ConstantProperty(
              new window.XEarth.Cartesian3(0, 0, -11)
            ),
            distanceDisplayCondition:
  ...
  createBillboardLabel_DC(val) {
    ...
    // var center = window.XEarth.Cartesian3.fromDegrees(
    //   108.95941558359958,
    //   34.219783901879,
    //   487.37960915730173
    // )
    ...
    window.EarthViewer.entities.add({
      ...
      billboard: {
        ...
        // imageSubRegion : new window.XEarth.BoundingRectangle(47, 80, 14, 14),
        name: 'singleWarning',
        show: true,
        width: val.width || 18,
        height: 4,
        // alignedAxis: new window.XEarth.Cartesian3(10, 0, 0),
        eyeOffset: new window.XEarth.ConstantProperty(
          new window.XEarth.Cartesian3(0, 0, -1)
        ),
        pixelOffset: val.offset,
        // sizeInMeters: true, //图像的尺寸被指定成图像实际的尺寸
        // pixelOffset : new window.XEarth.Cartesian2(0.0, 0),
        // position: window.XEarth.Cartesian3.fromDegrees(116.2, 39.53, 15),
        //   distanceDisplayCondition: new window.XEarth.DistanceDisplayCondition(0, 6.8e10),
        // verticalOrigin: window.XEarth.VerticalOrigin.TOP,
        scale: val.billboardScale || 6
        // scaleByDistance: new window.XEarth.NearFarScalar(1.5e2, 6.0, 1.5e7, 3.5)
      ...
      label: {
        ...
        fillColor: val.color || window.XEarth.Color.AQUA,
        style: window.XEarth.LabelStyle.FILL_AND_OUTLINE,
        // outlineWidth: 2,
        horizontalOrigin: window.XEarth.HorizontalOrigin.LEFT, //水平位置
        verticalOrigin: window.XEarth.VerticalOrigin.BOTTOM,
        pixelOffset:
          val.pixelOffset || new window.XEarth.Cartesian2(-43, -30),
        eyeOffset: new window.XEarth.ConstantProperty(
          new window.XEarth.Cartesian3(0, 0, -1)
        )
      }
  ...
  removeTerrianLayer() {
    window.EarthViewer.scene.terrainProvider =
      new window.XEarth.EllipsoidTerrainProvider({})
  }
  /**
   * 添加台湾高清影像
   */
  addTWGQYX() {
    let mvtProvider = new window.XEarth.UrlTemplateImageryProvider({
    ...
    window.cameraListener = function () {
      ...
      if (window.XEarth.Cartographic.fromCartesian(e).height < 300000) {
        // 显示自定义的天空盒
    ...
    nanhaiLFJD.forEach((element) => {
      window.EarthViewer.entities.add({
        ...
        billboard: {
          ...
          pixelOffset: new window.XEarth.Cartesian2(0.0, -45),
          scaleByDistance: new window.XEarth.NearFarScalar(
            1.5e2,
            6.0,
            1.5e7,
  ...
  addJiDi() {
    window.EarthViewer.dataSources
      .add(
        window.XEarth.GeoJsonDataSource.load('static/geojson/mubiao.json')
      )
      .then((data) => {
        let entitys = data.entities.values
        entitys.forEach((e) => {
          e.billboard = new window.XEarth.BillboardGraphics({
            image: 'static/image/billboard/camera-normal.png',
            show: true,
            width: 5,
            height: 5,
            ...
            pixelOffset: new window.XEarth.Cartesian2(0.0, -15),
            scaleByDistance: new window.XEarth.NearFarScalar(
              1.5e2,
              6.0,
              1.5e7,
            ...
            distanceDisplayCondition:
              new window.XEarth.DistanceDisplayCondition(0, 50e5)
          })
          e.label = new window.XEarth.LabelGraphics({
            //文字标签
            text: e.properties._名称._value,
            fillColor: window.XEarth.Color.DEEPSKYBLUE,
            font: '15px 黑体',
            style: window.XEarth.LabelStyle.FILL_AND_OUTLINE,
            outlineColor: window.XEarth.Color.BLACK,
            outlineWidth: 2,
            horizontalOrigin: window.XEarth.HorizontalOrigin.LEFT,
            verticalOrigin: window.XEarth.VerticalOrigin.CENTER,
            pixelOffset: new window.XEarth.Cartesian2(-20, -50),
            // showBackground: true,
            backgroundColor: new window.XEarth.Color.fromBytes(235, 155, 33),
            distanceDisplayCondition:
              new window.XEarth.DistanceDisplayCondition(0, 50e5)
  ...
  addRiver() {
    window.EarthViewer.dataSources
      .add(window.XEarth.GeoJsonDataSource.load('static/geojson/river.json'))
      .then((data) => {
        let entitys = data.entities.values
        entitys.forEach((e) => {
          // console.log('河流', e.polyline.width)
          e.polyline.width = 1.5
          e.polyline.material = new window.XEarth.Color(
            175 / 255,
            208 / 255,
            241 / 255,
            0.5
  ...
  addChina() {
    window.EarthViewer.entities.add({
      ...
      billboard: {
        ...
        pixelOffset: new window.XEarth.Cartesian2(0.0, -1),
        scaleByDistance: new window.XEarth.NearFarScalar(
          1.5e2,
          6.0,
          1.5e7,
      ...
      label: {
        ...
        fillColor: new window.XEarth.Color(230 / 255, 0 / 255, 0 / 255, 0.7),
        style: window.XEarth.LabelStyle.FILL,
        // style: window.XEarth.LabelStyle.FILL_AND_OUTLINE,
        horizontalOrigin: window.XEarth.HorizontalOrigin.LEFT,
        verticalOrigin: window.XEarth.VerticalOrigin.CENTER,
        pixelOffset: new window.XEarth.Cartesian2(-25, -20),
        // showBackground: true,
        backgroundColor: new window.XEarth.Color.fromBytes(235, 155, 33),
        distanceDisplayCondition: new window.XEarth.DistanceDisplayCondition(
          0,
    ...
    window.EarthViewer.entities.add({
      ...
      label: {
        ...
        horizontalOrigin: window.XEarth.HorizontalOrigin.LEFT,
        verticalOrigin: window.XEarth.VerticalOrigin.CENTER,
        pixelOffset: new window.XEarth.Cartesian2(-25, -80),
        // showBackground: true,
        backgroundColor: new window.XEarth.Color.fromBytes(235, 155, 33),
        distanceDisplayCondition: new window.XEarth.DistanceDisplayCondition(
          20e5,
  ...
  addMainCity() {
    window.EarthViewer.dataSources
      ...
      .then((data) => {
        ...
        entitys.forEach((e) => {
          ...
          let cartogra =
            window.XEarth.Cartographic.fromCartesian(position)
          ...
          e.position = new window.XEarth.Cartesian3.fromDegrees(sourceLng, sourceLat, sourceAlt)
          e.billboard = new window.XEarth.BillboardGraphics({
            ...
            // pixelOffset: new window.XEarth.Cartesian2(0.0, -20),
            scaleByDistance: new window.XEarth.NearFarScalar(
              1.5e2,
              6.0,
              1.5e7,
            ...
            distanceDisplayCondition:
              new window.XEarth.DistanceDisplayCondition(10e5, 70e5),
    ...
    window.EarthViewer.dataSources
      ...
      .then((data) => {
        ...
        entitys.forEach((e) => {
          ...
          //   ),
          //   distanceDisplayCondition:
          //     new window.XEarth.DistanceDisplayCondition(0, 300e5)
          // }
          e.label = {
            text: e.name,
    ...
    //     horizontalOrigin: window.XEarth.HorizontalOrigin.LEFT,
    //     verticalOrigin: window.XEarth.VerticalOrigin.CENTER,
    //     pixelOffset: new window.XEarth.Cartesian2(-35, -10),
    //     // showBackground: true,
    ...
    //     horizontalOrigin: window.XEarth.HorizontalOrigin.LEFT,
    //     verticalOrigin: window.XEarth.VerticalOrigin.CENTER,
    //     // pixelOffset: new window.XEarth.Cartesian2(-85, -10),
    //     // showBackground: true,
    //     outlineColor: window.XEarth.Color.WHITE,
    //     outlineWidth: 2,
    //     backgroundColor: new window.XEarth.Color.fromBytes(235, 155, 33),
  ...
  guojiexian_C() {
    const options1 = {
      ...
      color: new window.XEarth.Color(164 / 255, 91 / 255, 82 / 255, 1.0),
      addLabel: false,
      dataType: 'vector',
      geoType: 'polyline',
      width: 2,
    ...
    taiwanCity.forEach((item) => {
      ...
      window.EarthViewer.entities.add({
        ...
        label: {
          ...
          horizontalOrigin: window.XEarth.HorizontalOrigin.LEFT, //水平位置
          verticalOrigin: window.XEarth.VerticalOrigin.BOTTOM,
          pixelOffset: new window.XEarth.Cartesian2(-35, -31),
          eyeOffset: new window.XEarth.ConstantProperty(
            new window.XEarth.Cartesian3(0, 0, -12)
          ),
          distanceDisplayCondition:
            new window.XEarth.DistanceDisplayCondition(0, 100e5)
        }
  ...
  addTWXZQH() {
    ...
    const options = {
      ...
      color: window.XEarth.Color.RED.withAlpha(0.5),
      addLabel: false,
      dataType: 'vector',
      geoType: 'polyline',
      id: 'taiwanxzqh'
    ...
    elevationPoints.forEach((element) => {
      window.EarthViewer.entities.add({
        ...
        label: {
          text: `${element.value}`,
          distanceDisplayCondition:
            new window.XEarth.DistanceDisplayCondition(
              0,
              // 2e5
              10e5
            ),
          ...
          scale: 0.6,
          fillColor: window.XEarth.Color.YELLOW,
          style: window.XEarth.LabelStyle.FILL_AND_OUTLINE,
          // horizontalOrigin: window.XEarth.HorizontalOrigin.LEFT, //水平位置
          // verticalOrigin: window.XEarth.VerticalOrigin.BOTTOM,
          pixelOffset: new window.XEarth.Cartesian2(0, -15),
          eyeOffset: new window.XEarth.ConstantProperty(
            new window.XEarth.Cartesian3(0, 0, -1)
          )
        }
  ...
  add_ZY_Slope_Aspect(type) {
    switch (type) {
      case '中印边界坡度':
        ...
        let slope = new window.XEarth.UrlTemplateImageryProvider({
      ...
      case '中印边界坡向':
        ...
        let aspect = new window.XEarth.UrlTemplateImageryProvider({
   ...
   */
  add_ZYContourLine() {
    let webmercator1 = new window.XEarth.UrlTemplateImageryProvider({
    ...
    let webmercator2 = new window.XEarth.UrlTemplateImageryProvider({
    ...
    // window.cameraListener = function () {
    //   var e = window.EarthViewer.camera.position
    //   // console.log(window.XEarth.Cartographic.fromCartesian(e).height, webmercator2.show);
    //   if (
    //     window.XEarth.Cartographic.fromCartesian(e).height < 50000 &&
    //     window.XEarth.Cartographic.fromCartesian(e).height > 5000
    //   ) {
   ...
   */
  add_VectorBaseLayer() {
    let worldVectorLayer = new window.XEarth.UrlTemplateImageryProvider({
  ...
  //   }
  //   if (type) {
  //     window.loadPost2 = new window.XEarth.PostProcessStage({
  //       name: 'load',
  //       fragmentShader: loadGLSL
  //     })
    ...
    zy_taishiPoints.forEach((item) => {
      window.EarthViewer.entities.add({
        ...
        billboard: {
          ...
          pixelOffset: new window.XEarth.Cartesian2(0, -3),
          // pixelOffset: new window.XEarth.Cartesian2(0.0, -20),
          scaleByDistance: new window.XEarth.NearFarScalar(
            1.5e2,
            6.0,
   ...
   */
  add_dengwenxian() {
    var promise = window.XEarth.GeoJsonDataSource.load(
  ...
  add_taiwan_terrain_vector() {
    let webmercato1 = new window.XEarth.UrlTemplateImageryProvider({
    ...
    taiwan12biaozhu.forEach((e) => {
      window.EarthViewer.entities.add({
        ...
        label: {
          text: e.name,
          font: e.font,
          fillColor: window.XEarth.Color.BLACK,
          style: window.XEarth.LabelStyle.FILL_AND_OUTLINE,
          horizontalOrigin: window.XEarth.HorizontalOrigin.LEFT,
          verticalOrigin: window.XEarth.VerticalOrigin.CENTER,
          // pixelOffset: new window.XEarth.Cartesian2(-35, -10),
      ...
      //     new window.XEarth.DistanceDisplayCondition(3e3, 25e5)
      // }
    })
  }
  /**
  ...
  add_YJDG() {
    ...
    basicVectorData.yejiandengguang.forEach((dg) => {
      var promise = window.XEarth.GeoJsonDataSource.load(dg.dgUrl)
      promise.then(function (dataSource) {
        ...
        for (let index = 0; index < entities.length; index++) {
          ...
          switch (en.properties.ContourMin._value) {
            case 10:
              color = new window.XEarth.Color(0.9, 0.9, 0.9, 0.7)
              break
            case 30:
              color = new window.XEarth.Color(0.92, 0.92, 0.92, 0.75)
              break
            case 40:
              color = new window.XEarth.Color(0.94, 0.94, 0.94, 0.84)
              break
            case 50:
              color = new window.XEarth.Color(0.96, 0.96, 0.96, 0.88)
              break
            case 60:
              color = new window.XEarth.Color(0.98, 0.98, 0.98, 0.92)
              break
            default:
              color = new window.XEarth.Color(0.99, 0.99, 0.99, 0.98)
              break
          }
    ...
    basicVectorData.yejiandengguangLine.forEach((dg) => {
      ...
      promise.then(function (dataSource) {
        ...
        for (let index = 0; index < entities.length; index++) {
          ...
          en.polyline.material = new window.XEarth.FlowLineMaterialProperty({
            transparent: true,
            mixColor: new window.XEarth.Color(1.0, 1.0, 1.0, 1.0),
            // mixColor: color,
            mixRatio: 0.9,
            flowSpeed: 2.0,
            repeat: new window.XEarth.Cartesian2(4, 4),
  ...
  change_BaseLayerColor() {
    ...
    // let imageryProvider = new window.XEarth.UrlTemplateImageryProvider({
    //   url: googleConfig.url4,
    //   // tilingScheme: new window.XEarth.WebMercatorTilingScheme() //url5
    //   tilingScheme: new window.XEarth.GeographicTilingScheme() //url4
    // })
    // let layer =
    ...
    importantPosition.map((item) => {
      window.EarthViewer.entities.add({
        ...
        billboard: {
          ...
          // distanceDisplayCondition: new window.XEarth.DistanceDisplayCondition(4e3, 6e6),
          scale: 0.8
        },
        label: {
          text: item.name,
          ...
          horizontalOrigin: window.XEarth.HorizontalOrigin.LEFT,
          pixelOffset: new window.XEarth.Cartesian2(25, -2),
          style: window.XEarth.LabelStyle.FILL_AND_OUTLINE,
          fillColor: window.XEarth.Color.fromCssColorString('#1E90FF'),
          outlineColor: window.XEarth.Color.BLACK,
          outlineWidth: 5
          // distanceDisplayCondition: new window.XEarth.DistanceDisplayCondition(4e3, 1e6)
        }
      })
    })
  }
  ...
  baseGif(e) {
    ...
    superGif.load(function () {
      viewer.entities.add({
        ...
        billboard: {
          image: new window.XEarth.CallbackProperty(() => {
          ...
          eyeOffset: new window.XEarth.Cartesian3(0, 0, -2)
        }
      })
    })
  }
  ...
  addDLAirport = () => {
    console.log('被调用')
    // 图片材质
    // let imgMaterial = new window.XEarth.ImageMaterialProperty({
    //   image: './static/billboard/1.png'
    //   // repeat: new window.XEarth.Cartesian2(4, 4),
    //   // color: window.XEarth.Color.BLUE,
    // })
    window.EarthViewer.dataSources
      .add(
        window.XEarth.GeoJsonDataSource.load(
          ...
          {
            stroke: window.XEarth.Color.WHITE,
            fill: window.XEarth.Color.BLUE.withAlpha(0.3), //注意：颜色必须大写，即不能为blue
            strokeWidth: 5
          }
        )
      )
      .then((data) => {
        ...
        for (const key in array) {
          ...
          // )
          //   ? new window.XEarth.Color(231 / 255, 64 / 255, 50 / 255, 1.0)
          //   : new window.XEarth.Color(42 / 255, 156 / 255, 73 / 255, 1.0)
          // 机场适飞情况判断
          ...
          // array[key].label = new window.XEarth.LabelGraphics({
          //   text: array[key].properties.chineseName,
          //   fillColor: window.XEarth.Color.AQUA,
          //   // fillColor: new window.XEarth.Color(0.0, 1.0, 1.0, 1.0), //250, 251, 0
          //   // outlineColor:
          //   showBackground: false,
          //   scale: 0.4,
          //   pixelOffset: new window.XEarth.Cartesian2(0, -35),
          //   distanceDisplayCondition: new window.XEarth.DistanceDisplayCondition(
          //     0,
          //     // 2e5
          //     18e5
          //   )
          //   // scaleByDistance: new window.XEarth.NearFarScalar(0, 2.2, 2e5, 1.2)
          // })

          array[key].billboard = {
            // image: 'static/image/billboard/空军基地.png',
            image: './static/image/billboard/flyblue.png',
            // rotation: window.XEarth.Math.toRadians(direction),
            // scaleByDistance: new window.XEarth.NearFarScalar(1.0e3, 10.0, 2.0e3, 1.0),
            scale: 2,
            distanceDisplayCondition:
              new window.XEarth.DistanceDisplayCondition(0, 30e5),
            scaleByDistance: new window.XEarth.NearFarScalar(
          ...
          array[key].label = {
            ...
            horizontalOrigin: window.XEarth.HorizontalOrigin.LEFT,
            verticalOrigin: window.XEarth.VerticalOrigin.CENTER,
            pixelOffset: new window.XEarth.Cartesian2(-40, -40),
            outlineColor: window.XEarth.Color.BLACK,
            outlineWidth: 2,
            // showBackground: true,
            backgroundColor: new window.XEarth.Color.fromBytes(235, 155, 33),
          ...
          //   semiMajorAxis: 10000,
          //   material: new window.XEarth.PulseMaterialProperty({
          //     color: new window.XEarth.Color(231 / 255, 64 / 255, 50 / 255, 1.0), // 227, 62, 49
          //     // mixColor: new window.XEarth.Color(227 / 255, 62 / 255, 49 / 255, 1.0),
          //     repeat: new window.XEarth.Cartesian2(1.0, 1.0),
          //     // half: false,
          //     flowSpeed: 45
          //   })
